...
export default function RoadmapPage() {
  return (
    <PageShell
      ...
      title="A clearer roadmap for the next stages of Util."
      intro="The surrounding filler is gone so the roadmap itself can carry the page with more confidence, space, and visual rhythm."
    >
      <section>
                ...
                {roadmapItems.map((item, index) => (
                  ...
                  >
                    <div className="relative md:pl-14">
                      <div className="absolute left-[15px] top-8 hidden h-3 w-3 rounded-full border border-[#B7C3E2]/40 bg-[#7E47E7] shadow-[0_0_18px_rgba(126,71,231,0.45)] md:block" />
